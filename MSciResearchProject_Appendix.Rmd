...
```{r ToStart}
read.csv("../R/ToStart/ToPassOn/Clinical_data_SB_OnlyNeeded.csv")
read.table("../R/ToStart/ToPassOn/Normalised_Discovery_Expression.txt")
read.table("../R/ToStart/ToPassOn/Normalised_validation_Expression.txt")
read.table("../R/ToStart/ToPassOn/Validation_Pheno_Data.txt")
read.table("../R/ToStart/ToPassOn/Discovery_Pheno_Data.txt")
...
openxlsx::saveWorkbook(wb, file = "DE_Tables_Andrew_.xlsx", overwrite = T)
```
...
Activity <- ifelse(vali_pheno2["Muscular.domain"] < 1, "NoAct", "AnyAct")
plot_data   <- mutate(vali_pheno2, as.factor(Activity)) 
plot_data   <- na.omit(plot_data)

gene_expr <- t(vali_in2[row.names(vali_in2) == "ILMN_1749662",])
